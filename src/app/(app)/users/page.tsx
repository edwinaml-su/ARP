  ...
  return (
    <div className="card overflow-hidden">
      <div className="border-b border-slate-200 px-5 py-4">
        <h2 className="text-base font-bold text-slate-900">Usuarios y roles ({users.length})</h2>
        <p className="text-xs text-slate-400">
          Admin: todo · Editor: horarios/destinatarios/parametros · Lector: solo lectura.
        </p>
      </div>
            ...
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-slate-50">
                ...
                <td className="td text-center">
                  <InlineToggle endpoint="/api/users" id={u.id} value={!!u.active} disabled={u.id === me.id} />
                </td>
